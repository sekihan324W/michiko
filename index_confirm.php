		...
		<!-- Header -->
			<div id="header">
				...
				<div class="top">
					...
					<!-- Logo -->
						<div id="logo">
							<a href="./"><span class="image avatar48"><img src="images/avatar.png" alt="" /></span>
					...
					<section id="top" class="one dark cover">
							...
							<div class="container">
								<header>
									...
									<div class="img-wrap">
										<img src="images/front-avatar.png" alt="">
									</div>
					...
					<div class="container">
						<header>
							...
							<div class="swiper-container">
								...
								<div class="slide-img"><img src="images/works-img03.jpg" alt=""></div>
								...
								<div class="swiper-slide">
								<div class="slide-img"><img src="images/works-img02.jpg" alt=""></div>
								<div class="slide-content">
								<h1>メディア出演</h1>
								<p>Personality</p>
								</div>
								...
								<div class="swiper-slide">
								<div class="slide-img"><img src="images/works-img01.jpg" alt=""></div>
								<div class="slide-content">
								<h1>イベント企画</h1>
								<p>Event</p>
								</div>
							...
							<div class="row">
								<div class="col-6 col-6-mobile">
									<article class="item">
										<header>
											...
											<a href="#" target="_blank" class="image fit"><img src="images/pic06.jpg" alt="" /></a>
								...
								<div class="col-6 col-6-mobile">
									<article class="item">
										<header>
											<div class="m-radio">Radio</div>
											<a href="#" target="_blank" class="image fit"><img src="images/pic05.jpg" alt="" /></a>
				...
				<!-- About Me -->
					<section id="about" class="three">
						<div class="container fadein">
							...
							<img src="images/pic08.jpg" alt="" class="image featured" />
